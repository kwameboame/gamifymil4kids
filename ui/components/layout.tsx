          ...
          <div className="container mx-auto px-4">
            <div className="flex flex-wrap justify-between items-center">
              ...
              <div className="w-full md:w-1/3">
                <h4 className="text-md font-semibold mb-2">Project Partners</h4>
                <div className="flex space-x-4">
                  {/* Replace with actual sponsor logos */}
                  <Image src="/images/ppblogo.png" alt="PenPlusBytes" width={50} height={50} />
            ...
            <div className="mt-8 text-center text-sm">
              <p>&copy; 2024 StorylineGame. All rights reserved.</p>
            </div>
          </div>
        </footer>
      </div>
